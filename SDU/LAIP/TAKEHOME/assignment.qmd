...
\newpage
We want to replace the absolute value with something more linear, let's introduce a set of additional variables responisble for that, $\tau_t$
...
Has exactly $2N$ variables and $2N + 2$ (or $3N+2$ if we include $x_j \geq 0$) constraints
\clearpage\newpage
