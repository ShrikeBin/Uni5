...
This basically concludes *Task 1* but I wanted to explore a certain idea with the presented models.
...
\hat{\text{SE}}(\hat{\psi}) &=\sqrt{Var(\hat{\alpha}_2 - \hat{\alpha}_3)}\\
&= \sqrt{cVar(\hat{\beta})c^T},\\
